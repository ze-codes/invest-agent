...
def build_agent_step_prompt(align_with_brief: bool = True) -> str:
    ...
    base = (
        ...
        "Else, respond as: \n"
        "FINAL <answer>\n"
        "Constraints: keep under 200 words; no invented numbers; cite IDs exactly.\n"
        "If the question is definitional (e.g., 'what is X', 'define X', 'meaning of X'), FIRST fetch documentation: \n"
        "- If X is an indicator_id in KnownIDs, call get_indicator_doc {\"id\":\"X\"}.\n"
        "- If X is a series_id in KnownIDs, call get_series_doc {\"id\":\"X\"}.\n"
